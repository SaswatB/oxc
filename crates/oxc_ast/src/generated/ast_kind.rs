...
pub enum AstType {
    ...
    YieldExpression = 81,
    ExpressionWithTypeArguments = 82,
    ClassExtends = 83,
    Class = 84,
    ClassBody = 85,
    MethodDefinition = 86,
    ...
    WithClause = 96,
    ImportAttribute = 97,
    ExportNamedDeclaration = 98,
    ExportDefaultDeclaration = 99,
    ExportAllDeclaration = 100,
    ExportSpecifier = 101,
    TSThisParameter = 102,
    TSEnumDeclaration = 103,
    TSEnumMember = 104,
    TSTypeAnnotation = 105,
    TSLiteralType = 106,
    TSConditionalType = 107,
    TSUnionType = 108,
    TSIntersectionType = 109,
    TSParenthesizedType = 110,
    TSTypeOperator = 111,
    TSArrayType = 112,
    TSIndexedAccessType = 113,
    TSTupleType = 114,
    TSNamedTupleMember = 115,
    TSOptionalType = 116,
    TSRestType = 117,
    TSAnyKeyword = 118,
    TSStringKeyword = 119,
    TSBooleanKeyword = 120,
    TSNumberKeyword = 121,
    TSNeverKeyword = 122,
    TSIntrinsicKeyword = 123,
    TSUnknownKeyword = 124,
    TSNullKeyword = 125,
    TSUndefinedKeyword = 126,
    TSVoidKeyword = 127,
    TSSymbolKeyword = 128,
    TSThisType = 129,
    TSObjectKeyword = 130,
    ...
    TSTypeReference = 132,
    TSQualifiedName = 133,
    TSTypeParameterInstantiation = 134,
    TSTypeParameter = 135,
    TSTypeParameterDeclarationList = 136,
    TSTypeAliasDeclaration = 137,
    TSClassImplements = 138,
    TSInterfaceDeclaration = 139,
    TSInterfaceBody = 140,
    TSPropertySignature = 141,
    TSIndexSignature = 142,
    TSCallSignatureDeclaration = 143,
    TSMethodSignature = 144,
    TSConstructSignatureDeclaration = 145,
    TSIndexSignatureName = 146,
    TSInterfaceHeritage = 147,
    TSTypePredicate = 148,
    ...
    TSTypeQuery = 153,
    TSImportType = 154,
    TSImportAttributes = 155,
    TSImportAttribute = 156,
    TSFunctionType = 157,
    TSConstructorType = 158,
    TSMappedType = 159,
    ...
    TSNamespaceExportDeclaration = 169,
    ...
    JSXMemberExpression = 181,
    JSXExpressionContainer = 182,
    JSXEmptyExpression = 183,
    JSXAttribute = 184,
    JSXSpreadAttribute = 185,
    JSXIdentifier = 186,
    JSXSpreadChild = 187,
    JSXText = 188,
}
