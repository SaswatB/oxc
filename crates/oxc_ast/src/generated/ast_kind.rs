...
pub enum AstType {
    ...
    ObjectExpression = 14,
    ObjectProperty = 15,
    TemplateExpression = 16,
    NoSubstitutionTemplateLiteral = 17,
    TaggedTemplateExpression = 18,
    TemplateElement = 19,
    ElementAccessExpression = 20,
    StaticMemberExpression = 21,
    PrivateFieldExpression = 22,
    CallExpression = 23,
    NewExpression = 24,
    MetaProperty = 25,
    SpreadElement = 26,
    UpdateExpression = 27,
    UnaryExpression = 28,
    GeneralBinaryExpression = 29,
    PrivateInExpression = 30,
    LogicalExpression = 31,
    ConditionalExpression = 32,
    AssignmentExpression = 33,
    ArrayAssignmentTarget = 34,
    ObjectAssignmentTarget = 35,
    AssignmentTargetRest = 36,
    AssignmentTargetWithDefault = 37,
    AssignmentTargetPropertyIdentifier = 38,
    AssignmentTargetPropertyProperty = 39,
    ...
    DestructureBindingPattern = 70,
    AssignmentPattern = 71,
    ObjectPattern = 72,
    BindingProperty = 73,
    ArrayPattern = 74,
    ArrayPatternElement = 75,
    BindingRestElement = 76,
    Function = 77,
    FormalParameters = 78,
    FormalParameter = 79,
    FunctionBody = 80,
    ArrowFunctionExpression = 81,
    YieldExpression = 82,
    ExpressionWithTypeArguments = 83,
    ClassExtends = 84,
    Class = 85,
    ClassBody = 86,
    MethodDefinition = 87,
    PropertyDefinition = 88,
    PrivateIdentifier = 89,
    StaticBlock = 90,
    AccessorProperty = 91,
    ImportExpression = 92,
    ImportDeclaration = 93,
    ImportSpecifier = 94,
    ImportDefaultSpecifier = 95,
    ImportNamespaceSpecifier = 96,
    WithClause = 97,
    ImportAttribute = 98,
    ExportNamedDeclaration = 99,
    ExportDefaultDeclaration = 100,
    ExportAllDeclaration = 101,
    ExportSpecifier = 102,
    TSThisParameter = 103,
    TSEnumDeclaration = 104,
    TSEnumMember = 105,
    TSTypeAnnotation = 106,
    TSLiteralType = 107,
    TSConditionalType = 108,
    TSUnionType = 109,
    TSIntersectionType = 110,
    TSParenthesizedType = 111,
    TSTypeOperator = 112,
    TSArrayType = 113,
    TSIndexedAccessType = 114,
    TSTupleType = 115,
    TSNamedTupleMember = 116,
    TSOptionalType = 117,
    TSRestType = 118,
    TSAnyKeyword = 119,
    TSStringKeyword = 120,
    TSBooleanKeyword = 121,
    TSNumberKeyword = 122,
    TSNeverKeyword = 123,
    TSIntrinsicKeyword = 124,
    TSUnknownKeyword = 125,
    TSNullKeyword = 126,
    ...
    TSTypeReference = 133,
    TSQualifiedName = 134,
    TSTypeParameterInstantiation = 135,
    TSTypeParameter = 136,
    TSTypeParameterDeclarationList = 137,
    TSTypeAliasDeclaration = 138,
    TSClassImplements = 139,
    TSInterfaceDeclaration = 140,
    TSInterfaceBody = 141,
    TSPropertySignature = 142,
    TSIndexSignature = 143,
    TSCallSignatureDeclaration = 144,
    TSMethodSignature = 145,
    TSConstructSignatureDeclaration = 146,
    TSIndexSignatureName = 147,
    ...
    TSTypeQuery = 154,
    TSImportType = 155,
    TSImportAttributes = 156,
    TSImportAttribute = 157,
    TSFunctionType = 158,
    TSConstructorType = 159,
    TSMappedType = 160,
    ...
    TSNamespaceExportDeclaration = 170,
    ...
    JSXNamespacedName = 181,
    JSXMemberExpression = 182,
    JSXExpressionContainer = 183,
    JSXEmptyExpression = 184,
    JSXAttribute = 185,
...
pub enum AstKind<'a> {
    ...
    TemplateExpression(&'a TemplateExpression<'a>) = AstType::TemplateExpression as u8,
    NoSubstitutionTemplateLiteral(&'a NoSubstitutionTemplateLiteral<'a>) =
        AstType::NoSubstitutionTemplateLiteral as u8,
    ...
    ExpressionWithTypeArguments(&'a ExpressionWithTypeArguments<'a>) =
        AstType::ExpressionWithTypeArguments as u8,
    ClassExtends(&'a ClassExtends<'a>) = AstType::ClassExtends as u8,
...
impl GetSpan for AstKind<'_> {
    ...
    fn span(&self) -> Span {
        match self {
            ...
            Self::TemplateExpression(it) => it.span(),
            Self::NoSubstitutionTemplateLiteral(it) => it.span(),
            ...
            Self::ExpressionWithTypeArguments(it) => it.span(),
            Self::ClassExtends(it) => it.span(),
...
impl<'a> AstKind<'a> {
    pub fn get_children(&self) -> Vec<AstKind<'a>> {
        match self {
            ...
            Self::TemplateExpression(it) => it.get_children(),
            Self::NoSubstitutionTemplateLiteral(it) => it.get_children(),
            ...
            Self::ExpressionWithTypeArguments(it) => it.get_children(),
            Self::ClassExtends(it) => it.get_children(),
    ...
    pub fn get_node_id(&self) -> u32 {
        match self {
            ...
            Self::TemplateExpression(it) => it.get_node_id(),
            Self::NoSubstitutionTemplateLiteral(it) => it.get_node_id(),
            ...
            Self::ExpressionWithTypeArguments(it) => it.get_node_id(),
            Self::ClassExtends(it) => it.get_node_id(),
...
impl<'a> AstKind<'a> {
    ...
    #[inline]
    pub fn as_template_expression(self) -> Option<&'a TemplateExpression<'a>> {
        if let Self::TemplateExpression(v) = self {
            Some(v)
        } else {
            None
        }
    ...
    pub fn as_no_substitution_template_literal(
        self,
    ) -> Option<&'a NoSubstitutionTemplateLiteral<'a>> {
        if let Self::NoSubstitutionTemplateLiteral(v) = self {
            Some(v)
        } else {
            None
        }
    ...
    #[inline]
    pub fn as_expression_with_type_arguments(self) -> Option<&'a ExpressionWithTypeArguments<'a>> {
        if let Self::ExpressionWithTypeArguments(v) = self {
            Some(v)
        } else {
            None
        }
    ...
    #[inline]
    pub fn as_class_extends(self) -> Option<&'a ClassExtends<'a>> {
        if let Self::ClassExtends(v) = self {
            Some(v)
        } else {
            None
        }
