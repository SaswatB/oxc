...
pub enum AstType {
    ...
    ClassBody = 84,
    MethodDefinition = 85,
    PropertyDefinition = 86,
    PrivateIdentifier = 87,
    StaticBlock = 88,
    AccessorProperty = 89,
    ImportExpression = 90,
    ImportDeclaration = 91,
    ImportSpecifier = 92,
    ImportDefaultSpecifier = 93,
    ImportNamespaceSpecifier = 94,
    WithClause = 95,
    ImportAttribute = 96,
    ExportNamedDeclaration = 97,
    ExportDefaultDeclaration = 98,
    ExportAllDeclaration = 99,
    ExportSpecifier = 100,
    TSThisParameter = 101,
    TSEnumDeclaration = 102,
    TSEnumMember = 103,
    TSTypeAnnotation = 104,
    TSLiteralType = 105,
    TSConditionalType = 106,
    TSUnionType = 107,
    TSIntersectionType = 108,
    TSParenthesizedType = 109,
    TSTypeOperator = 110,
    TSArrayType = 111,
    TSIndexedAccessType = 112,
    TSTupleType = 113,
    TSNamedTupleMember = 114,
    TSOptionalType = 115,
    TSRestType = 116,
    TSAnyKeyword = 117,
    TSStringKeyword = 118,
    TSBooleanKeyword = 119,
    TSNumberKeyword = 120,
    TSNeverKeyword = 121,
    TSIntrinsicKeyword = 122,
    TSUnknownKeyword = 123,
    TSNullKeyword = 124,
    TSUndefinedKeyword = 125,
    TSVoidKeyword = 126,
    TSSymbolKeyword = 127,
    TSThisType = 128,
    TSObjectKeyword = 129,
    ...
    TSTypeParameter = 134,
    TSTypeParameterDeclarationList = 135,
    TSTypeAliasDeclaration = 136,
    TSClassImplements = 137,
    TSInterfaceDeclaration = 138,
    TSInterfaceBody = 139,
    TSPropertySignature = 140,
    TSIndexSignature = 141,
    TSCallSignatureDeclaration = 142,
    TSMethodSignature = 143,
    TSConstructSignatureDeclaration = 144,
    TSIndexSignatureName = 145,
    TSInterfaceHeritage = 146,
    TSTypePredicate = 147,
    TSModuleDeclaration = 148,
    TSModuleBlock = 149,
    TSTypeLiteral = 150,
    TSInferType = 151,
    TSTypeQuery = 152,
    TSImportType = 153,
    TSImportAttributes = 154,
    TSImportAttribute = 155,
    TSFunctionType = 156,
    TSConstructorType = 157,
    TSMappedType = 158,
    ...
    TSNamespaceExportDeclaration = 168,
    TSInstantiationExpression = 169,
    JSDocNullableType = 170,
    JSDocNonNullableType = 171,
    JSDocUnknownType = 172,
    JSXElement = 173,
    JSXOpeningElement = 174,
    JSXClosingElement = 175,
    JSXFragment = 176,
    JSXOpeningFragment = 177,
    JSXClosingFragment = 178,
    JSXNamespacedName = 179,
    JSXMemberExpression = 180,
    JSXExpressionContainer = 181,
    JSXEmptyExpression = 182,
    JSXAttribute = 183,
