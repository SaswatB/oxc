...
pub trait Visit<'a>: Sized {
    ...
    #[inline]
    fn visit_source_file(&mut self, it: &SourceFile<'a>) {
    ...
    #[inline]
    fn visit_template_expression(&mut self, it: &TemplateExpression<'a>) {
    ...
    #[inline]
    fn visit_no_substitution_template_literal(&mut self, it: &NoSubstitutionTemplateLiteral<'a>) {
    ...
    #[inline]
    fn visit_omitted_expression(&mut self, it: &OmittedExpression) {
    ...
    fn visit_ts_type_parameter_declaration_list(
        &mut self,
        it: &TSTypeParameterDeclarationList<'a>,
    ) {
    ...
    #[inline]
    fn visit_destructure_binding_pattern(&mut self, it: &DestructureBindingPattern<'a>) {
        walk_destructure_binding_pattern(self, it);
    }

    #[inline]
    fn visit_destructure_binding_pattern_kind(&mut self, it: &DestructureBindingPatternKind<'a>) {
    ...
    #[inline]
    fn visit_element_access_expression(&mut self, it: &ElementAccessExpression<'a>) {
    ...
    #[inline]
    fn visit_expression_with_type_arguments(&mut self, it: &ExpressionWithTypeArguments<'a>) {
    ...
    #[inline]
    fn visit_template_literal_kind(&mut self, it: &TemplateLiteralKind<'a>) {
...
pub mod walk {
    ...
    #[inline]
    pub fn walk_source_file<'a, V: Visit<'a>>(visitor: &mut V, it: &SourceFile<'a>) {
        let kind = AstKind::SourceFile(visitor.alloc(it));
    ...
    #[inline]
    pub fn walk_template_expression<'a, V: Visit<'a>>(
        visitor: &mut V,
        it: &TemplateExpression<'a>,
    ) {
        let kind = AstKind::TemplateExpression(visitor.alloc(it));
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
    ...
    #[inline]
    pub fn walk_no_substitution_template_literal<'a, V: Visit<'a>>(
        visitor: &mut V,
        it: &NoSubstitutionTemplateLiteral<'a>,
    ) {
        let kind = AstKind::NoSubstitutionTemplateLiteral(visitor.alloc(it));
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
        visitor.leave_node(kind);
    }
    ...
    #[inline]
    pub fn walk_omitted_expression<'a, V: Visit<'a>>(visitor: &mut V, it: &OmittedExpression) {
        let kind = AstKind::OmittedExpression(visitor.alloc(it));
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
        visitor.leave_node(kind);
    }
    ...
    #[inline]
    pub fn walk_ts_type_parameter_declaration_list<'a, V: Visit<'a>>(
        visitor: &mut V,
        it: &TSTypeParameterDeclarationList<'a>,
    ) {
        let kind = AstKind::TSTypeParameterDeclarationList(visitor.alloc(it));
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
    ...
    pub fn walk_formal_parameter<'a, V: Visit<'a>>(visitor: &mut V, it: &FormalParameter<'a>) {
        ...
        visitor.visit_destructure_binding_pattern(&it.pattern);
        visitor.leave_node(kind);
    }
    ...
    #[inline]
    pub fn walk_destructure_binding_pattern<'a, V: Visit<'a>>(
        visitor: &mut V,
        it: &DestructureBindingPattern<'a>,
    ) {
        let kind = AstKind::DestructureBindingPattern(visitor.alloc(it));
        visitor.enter_node(kind);
        visitor.visit_destructure_binding_pattern_kind(&it.kind);
    ...
    #[inline]
    pub fn walk_destructure_binding_pattern_kind<'a, V: Visit<'a>>(
        visitor: &mut V,
        it: &DestructureBindingPatternKind<'a>,
    ) {
        match it {
    ...
    pub fn walk_binding_property<'a, V: Visit<'a>>(visitor: &mut V, it: &BindingProperty<'a>) {
        ...
        visitor.visit_destructure_binding_pattern(&it.value);
        visitor.leave_node(kind);
    }
    ...
    pub fn walk_binding_rest_element<'a, V: Visit<'a>>(
        ...
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
        visitor.visit_destructure_binding_pattern(&it.argument);
        visitor.leave_node(kind);
    }
    ...
    pub fn walk_assignment_pattern<'a, V: Visit<'a>>(visitor: &mut V, it: &AssignmentPattern<'a>) {
        ...
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
        visitor.visit_destructure_binding_pattern(&it.left);
    ...
    #[inline]
    pub fn walk_element_access_expression<'a, V: Visit<'a>>(
        visitor: &mut V,
        it: &ElementAccessExpression<'a>,
    ) {
        let kind = AstKind::ElementAccessExpression(visitor.alloc(it));
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
    ...
    pub fn walk_class_extends<'a, V: Visit<'a>>(visitor: &mut V, it: &ClassExtends<'a>) {
        ...
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
        visitor.visit_expression_with_type_arguments(&it.expression_with_type_arguments);
        visitor.leave_node(kind);
    }

    #[inline]
    pub fn walk_expression_with_type_arguments<'a, V: Visit<'a>>(
        visitor: &mut V,
        it: &ExpressionWithTypeArguments<'a>,
    ) {
        let kind = AstKind::ExpressionWithTypeArguments(visitor.alloc(it));
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
        visitor.visit_expression(&it.expression);
        if let Some(type_parameters) = &it.type_parameters {
    ...
    pub fn walk_tagged_template_expression<'a, V: Visit<'a>>(
        ...
        visitor.visit_template_literal_kind(&it.quasi);
        if let Some(type_parameters) = &it.type_parameters {
            visitor.visit_ts_type_parameter_instantiation(type_parameters);
        }
        visitor.leave_node(kind);
    ...
    #[inline]
    pub fn walk_template_literal_kind<'a, V: Visit<'a>>(
        visitor: &mut V,
        it: &TemplateLiteralKind<'a>,
    ) {
        match it {
    ...
    pub fn walk_variable_declarator<'a, V: Visit<'a>>(
        ...
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
        visitor.visit_destructure_binding_pattern(&it.id);
        if let Some(init) = &it.init {
            visitor.visit_expression(init);
        }
        visitor.leave_node(kind);
