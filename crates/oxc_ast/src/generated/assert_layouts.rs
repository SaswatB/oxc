...
const _: () = {
    ...
    assert!(size_of::<SourceFile>() == 176usize);
    assert!(align_of::<SourceFile>() == 8usize);
    assert!(offset_of!(SourceFile, node_id) == 0usize);
    assert!(offset_of!(SourceFile, span) == 8usize);
    assert!(offset_of!(SourceFile, source_type) == 16usize);
    assert!(offset_of!(SourceFile, source_text) == 24usize);
    assert!(offset_of!(SourceFile, comments) == 40usize);
    assert!(offset_of!(SourceFile, hashbang) == 72usize);
    assert!(offset_of!(SourceFile, directives) == 104usize);
    assert!(offset_of!(SourceFile, body) == 136usize);
    assert!(offset_of!(SourceFile, scope_id) == 168usize);
    ...
    assert!(offset_of!(IdentifierName, span) == 8usize);
    ...
    assert!(offset_of!(IdentifierReference, span) == 8usize);
    ...
    assert!(offset_of!(BindingIdentifier, span) == 8usize);
    ...
    assert!(offset_of!(ArrayExpression, span) == 8usize);
    ...
    assert!(offset_of!(ObjectExpression, span) == 8usize);
    ...
    assert!(offset_of!(ObjectProperty, span) == 8usize);
    assert!(offset_of!(ObjectProperty, kind) == 16usize);
    assert!(offset_of!(ObjectProperty, key) == 24usize);
    assert!(offset_of!(ObjectProperty, value) == 40usize);
    assert!(offset_of!(ObjectProperty, method) == 56usize);
    assert!(offset_of!(ObjectProperty, shorthand) == 57usize);
    assert!(offset_of!(ObjectProperty, computed) == 58usize);
    ...
    assert!(size_of::<TemplateExpression>() == 80usize);
    assert!(align_of::<TemplateExpression>() == 8usize);
    assert!(offset_of!(TemplateExpression, node_id) == 0usize);
    assert!(offset_of!(TemplateExpression, span) == 8usize);
    assert!(offset_of!(TemplateExpression, quasis) == 16usize);
    assert!(offset_of!(TemplateExpression, expressions) == 48usize);

    assert!(size_of::<NoSubstitutionTemplateLiteral>() == 32usize);
    assert!(align_of::<NoSubstitutionTemplateLiteral>() == 8usize);
    assert!(offset_of!(NoSubstitutionTemplateLiteral, node_id) == 0usize);
    assert!(offset_of!(NoSubstitutionTemplateLiteral, span) == 8usize);
    assert!(offset_of!(NoSubstitutionTemplateLiteral, value) == 16usize);

    assert!(size_of::<TemplateLiteralKind>() == 16usize);
    assert!(align_of::<TemplateLiteralKind>() == 8usize);

    assert!(size_of::<TaggedTemplateExpression>() == 56usize);
    ...
    assert!(offset_of!(TaggedTemplateExpression, type_parameters) == 48usize);
    ...
    assert!(offset_of!(TemplateElement, span) == 8usize);
    assert!(offset_of!(TemplateElement, tail) == 16usize);
    assert!(offset_of!(TemplateElement, value) == 24usize);
    ...
    assert!(offset_of!(PrivateFieldExpression, span) == 8usize);
    ...
    assert!(offset_of!(CallExpression, span) == 8usize);
    ...
    assert!(offset_of!(NewExpression, span) == 8usize);
    ...
    assert!(offset_of!(MetaProperty, span) == 8usize);
    ...
    assert!(offset_of!(SpreadElement, span) == 8usize);
    ...
    assert!(offset_of!(UpdateExpression, span) == 8usize);
    assert!(offset_of!(UpdateExpression, operator) == 16usize);
    assert!(offset_of!(UpdateExpression, prefix) == 17usize);
    assert!(offset_of!(UpdateExpression, argument) == 24usize);
    ...
    assert!(offset_of!(UnaryExpression, span) == 8usize);
    ...
    assert!(offset_of!(PrivateInExpression, span) == 8usize);
    ...
    assert!(offset_of!(LogicalExpression, span) == 8usize);
    ...
    assert!(offset_of!(ConditionalExpression, span) == 8usize);
    ...
    assert!(size_of::<AssignmentExpression>() == 56usize);
    assert!(align_of::<AssignmentExpression>() == 8usize);
    assert!(offset_of!(AssignmentExpression, node_id) == 0usize);
    assert!(offset_of!(AssignmentExpression, span) == 8usize);
    assert!(offset_of!(AssignmentExpression, operator) == 16usize);
    assert!(offset_of!(AssignmentExpression, left) == 24usize);
    assert!(offset_of!(AssignmentExpression, right) == 40usize);
    ...
    assert!(offset_of!(ArrayAssignmentTarget, span) == 8usize);
    ...
    assert!(offset_of!(ObjectAssignmentTarget, span) == 8usize);
    ...
    assert!(offset_of!(AssignmentTargetRest, span) == 8usize);
    ...
    assert!(offset_of!(AssignmentTargetWithDefault, span) == 8usize);
    ...
    assert!(offset_of!(AssignmentTargetPropertyIdentifier, span) == 8usize);
    ...
    assert!(offset_of!(AssignmentTargetPropertyProperty, computed) == 48usize);
    ...
    assert!(offset_of!(AwaitExpression, span) == 8usize);
    ...
    assert!(offset_of!(ChainExpression, span) == 8usize);
    ...
    assert!(offset_of!(ParenthesizedExpression, span) == 8usize);
    ...
    assert!(offset_of!(Hashbang, span) == 8usize);
    ...
    assert!(offset_of!(BlockStatement, span) == 8usize);
    ...
    assert!(offset_of!(VariableDeclarator, span) == 8usize);
    assert!(offset_of!(VariableDeclarator, kind) == 16usize);
    assert!(offset_of!(VariableDeclarator, id) == 24usize);
    assert!(offset_of!(VariableDeclarator, init) == 64usize);
    assert!(offset_of!(VariableDeclarator, definite) == 80usize);

    assert!(size_of::<EmptyStatement>() == 16usize);
    assert!(align_of::<EmptyStatement>() == 8usize);
    assert!(offset_of!(EmptyStatement, node_id) == 0usize);
    assert!(offset_of!(EmptyStatement, span) == 8usize);
    ...
    assert!(offset_of!(ExpressionStatement, span) == 8usize);
    ...
    assert!(offset_of!(IfStatement, span) == 8usize);
    ...
    assert!(offset_of!(DoWhileStatement, span) == 8usize);
    ...
    assert!(offset_of!(WhileStatement, span) == 8usize);
    ...
    assert!(offset_of!(ForStatement, span) == 8usize);
    ...
    assert!(offset_of!(ForInStatement, span) == 8usize);
    ...
    assert!(size_of::<ForOfStatement>() == 80usize);
    assert!(align_of::<ForOfStatement>() == 8usize);
    assert!(offset_of!(ForOfStatement, node_id) == 0usize);
    assert!(offset_of!(ForOfStatement, span) == 8usize);
    assert!(offset_of!(ForOfStatement, r#await) == 16usize);
    assert!(offset_of!(ForOfStatement, left) == 24usize);
    assert!(offset_of!(ForOfStatement, right) == 40usize);
    assert!(offset_of!(ForOfStatement, body) == 56usize);
    assert!(offset_of!(ForOfStatement, scope_id) == 72usize);
    ...
    assert!(offset_of!(ContinueStatement, span) == 8usize);
    ...
    assert!(offset_of!(BreakStatement, span) == 8usize);
    ...
    assert!(offset_of!(ReturnStatement, span) == 8usize);
    ...
    assert!(offset_of!(WithStatement, span) == 8usize);
    ...
    assert!(offset_of!(SwitchStatement, span) == 8usize);
    ...
    assert!(offset_of!(SwitchCase, span) == 8usize);
    ...
    assert!(offset_of!(LabeledStatement, span) == 8usize);
    ...
    assert!(offset_of!(ThrowStatement, span) == 8usize);
    ...
    assert!(offset_of!(TryStatement, span) == 8usize);
    ...
    assert!(offset_of!(CatchClause, span) == 8usize);
    ...
    assert!(offset_of!(CatchParameter, span) == 8usize);
    assert!(offset_of!(CatchParameter, pattern) == 16usize);

    assert!(size_of::<DebuggerStatement>() == 16usize);
    ...
    assert!(offset_of!(AssignmentPattern, span) == 8usize);
    ...
    assert!(offset_of!(ObjectPattern, span) == 8usize);
    ...
    assert!(offset_of!(BindingProperty, span) == 8usize);
    ...
    assert!(offset_of!(ArrayPattern, span) == 8usize);
    ...
    assert!(offset_of!(BindingRestElement, span) == 8usize);
    ...
    assert!(offset_of!(Function, r#type) == 16usize);
    assert!(offset_of!(Function, id) == 24usize);
    assert!(offset_of!(Function, generator) == 64usize);
    assert!(offset_of!(Function, r#async) == 65usize);
    assert!(offset_of!(Function, declare) == 66usize);
    assert!(offset_of!(Function, type_parameters) == 72usize);
    ...
    assert!(size_of::<FormalParameters>() == 64usize);
    assert!(align_of::<FormalParameters>() == 8usize);
    assert!(offset_of!(FormalParameters, node_id) == 0usize);
    assert!(offset_of!(FormalParameters, span) == 8usize);
    assert!(offset_of!(FormalParameters, kind) == 16usize);
    assert!(offset_of!(FormalParameters, items) == 24usize);
    assert!(offset_of!(FormalParameters, rest) == 56usize);
    ...
    assert!(offset_of!(FormalParameter, span) == 8usize);
    ...
    assert!(offset_of!(FunctionBody, span) == 8usize);
    assert!(offset_of!(FunctionBody, directives) == 16usize);
    assert!(offset_of!(FunctionBody, statements) == 48usize);

    assert!(size_of::<ArrowFunctionExpression>() == 64usize);
    assert!(align_of::<ArrowFunctionExpression>() == 8usize);
    assert!(offset_of!(ArrowFunctionExpression, node_id) == 0usize);
    assert!(offset_of!(ArrowFunctionExpression, span) == 8usize);
    assert!(offset_of!(ArrowFunctionExpression, expression) == 16usize);
    assert!(offset_of!(ArrowFunctionExpression, r#async) == 17usize);
    assert!(offset_of!(ArrowFunctionExpression, type_parameters) == 24usize);
    assert!(offset_of!(ArrowFunctionExpression, params) == 32usize);
    assert!(offset_of!(ArrowFunctionExpression, return_type) == 40usize);
    assert!(offset_of!(ArrowFunctionExpression, body) == 48usize);
    assert!(offset_of!(ArrowFunctionExpression, scope_id) == 56usize);
    ...
    assert!(offset_of!(YieldExpression, span) == 8usize);
    ...
    assert!(offset_of!(Class, r#type) == 16usize);
    assert!(offset_of!(Class, decorators) == 24usize);
    ...
    assert!(offset_of!(MethodDefinition, r#type) == 16usize);
    assert!(offset_of!(MethodDefinition, decorators) == 24usize);
    ...
    assert!(offset_of!(MethodDefinition, r#static) == 82usize);
    assert!(offset_of!(MethodDefinition, r#override) == 83usize);
    assert!(offset_of!(MethodDefinition, optional) == 84usize);
    assert!(offset_of!(MethodDefinition, accessibility) == 85usize);

    assert!(size_of::<MethodDefinitionType>() == 1usize);
    assert!(align_of::<MethodDefinitionType>() == 1usize);

    assert!(size_of::<PropertyDefinition>() == 112usize);
    ...
    assert!(offset_of!(PropertyDefinition, r#type) == 16usize);
    assert!(offset_of!(PropertyDefinition, decorators) == 24usize);
    assert!(offset_of!(PropertyDefinition, key) == 56usize);
    assert!(offset_of!(PropertyDefinition, value) == 72usize);
    assert!(offset_of!(PropertyDefinition, computed) == 88usize);
    assert!(offset_of!(PropertyDefinition, r#static) == 89usize);
    assert!(offset_of!(PropertyDefinition, declare) == 90usize);
    assert!(offset_of!(PropertyDefinition, r#override) == 91usize);
    assert!(offset_of!(PropertyDefinition, optional) == 92usize);
    assert!(offset_of!(PropertyDefinition, definite) == 93usize);
    assert!(offset_of!(PropertyDefinition, readonly) == 94usize);
    assert!(offset_of!(PropertyDefinition, type_annotation) == 96usize);
    assert!(offset_of!(PropertyDefinition, accessibility) == 104usize);
    ...
    assert!(offset_of!(PrivateIdentifier, span) == 8usize);
    ...
    assert!(offset_of!(StaticBlock, span) == 8usize);
    ...
    assert!(offset_of!(AccessorProperty, r#type) == 16usize);
    assert!(offset_of!(AccessorProperty, decorators) == 24usize);
    ...
    assert!(offset_of!(AccessorProperty, r#static) == 89usize);
    assert!(offset_of!(AccessorProperty, definite) == 90usize);
    assert!(offset_of!(AccessorProperty, type_annotation) == 96usize);
    assert!(offset_of!(AccessorProperty, accessibility) == 104usize);

    assert!(size_of::<ImportExpression>() == 72usize);
    assert!(align_of::<ImportExpression>() == 8usize);
    assert!(offset_of!(ImportExpression, node_id) == 0usize);
    assert!(offset_of!(ImportExpression, span) == 8usize);
    assert!(offset_of!(ImportExpression, source) == 16usize);
    assert!(offset_of!(ImportExpression, arguments) == 32usize);
    assert!(offset_of!(ImportExpression, phase) == 64usize);

    assert!(size_of::<ImportDeclaration>() == 120usize);
    assert!(align_of::<ImportDeclaration>() == 8usize);
    assert!(offset_of!(ImportDeclaration, node_id) == 0usize);
    assert!(offset_of!(ImportDeclaration, span) == 8usize);
    assert!(offset_of!(ImportDeclaration, specifiers) == 16usize);
    assert!(offset_of!(ImportDeclaration, source) == 48usize);
    assert!(offset_of!(ImportDeclaration, phase) == 96usize);
    assert!(offset_of!(ImportDeclaration, with_clause) == 104usize);
    assert!(offset_of!(ImportDeclaration, import_kind) == 112usize);
    ...
    assert!(offset_of!(ImportSpecifier, span) == 8usize);
    ...
    assert!(offset_of!(ImportDefaultSpecifier, span) == 8usize);
    ...
    assert!(offset_of!(ImportNamespaceSpecifier, span) == 8usize);
    ...
    assert!(offset_of!(TSThisParameter, span) == 8usize);
    assert!(offset_of!(TSThisParameter, this_span) == 16usize);
    ...
    assert!(offset_of!(TSEnumDeclaration, span) == 8usize);
    ...
    assert!(offset_of!(TSEnumMember, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeAnnotation, span) == 8usize);
    ...
    assert!(offset_of!(TSLiteralType, span) == 8usize);
    ...
    assert!(offset_of!(TSConditionalType, span) == 8usize);
    ...
    assert!(offset_of!(TSUnionType, span) == 8usize);
    ...
    assert!(offset_of!(TSIntersectionType, span) == 8usize);
    ...
    assert!(offset_of!(TSParenthesizedType, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeOperator, span) == 8usize);
    assert!(offset_of!(TSTypeOperator, operator) == 16usize);
    assert!(offset_of!(TSTypeOperator, type_annotation) == 24usize);
    ...
    assert!(offset_of!(TSArrayType, span) == 8usize);
    ...
    assert!(offset_of!(TSIndexedAccessType, span) == 8usize);
    ...
    assert!(offset_of!(TSTupleType, span) == 8usize);
    ...
    assert!(offset_of!(TSNamedTupleMember, span) == 8usize);
    ...
    assert!(offset_of!(TSOptionalType, span) == 8usize);
    ...
    assert!(offset_of!(TSRestType, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeReference, span) == 8usize);
    ...
    assert!(offset_of!(TSQualifiedName, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeParameterInstantiation, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeParameter, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeAliasDeclaration, span) == 8usize);
    ...
    assert!(offset_of!(TSInterfaceDeclaration, span) == 8usize);
    ...
    assert!(offset_of!(TSInterfaceBody, span) == 8usize);
    assert!(offset_of!(TSInterfaceBody, body) == 16usize);

    assert!(size_of::<TSPropertySignature>() == 48usize);
    assert!(align_of::<TSPropertySignature>() == 8usize);
    assert!(offset_of!(TSPropertySignature, node_id) == 0usize);
    assert!(offset_of!(TSPropertySignature, span) == 8usize);
    assert!(offset_of!(TSPropertySignature, computed) == 16usize);
    assert!(offset_of!(TSPropertySignature, optional) == 17usize);
    assert!(offset_of!(TSPropertySignature, readonly) == 18usize);
    assert!(offset_of!(TSPropertySignature, key) == 24usize);
    assert!(offset_of!(TSPropertySignature, type_annotation) == 40usize);
    ...
    assert!(offset_of!(TSIndexSignature, span) == 8usize);
    ...
    assert!(offset_of!(TSIndexSignature, r#static) == 57usize);
    ...
    assert!(offset_of!(TSCallSignatureDeclaration, span) == 8usize);
    assert!(offset_of!(TSCallSignatureDeclaration, type_parameters) == 16usize);
    assert!(offset_of!(TSCallSignatureDeclaration, this_param) == 24usize);
    assert!(offset_of!(TSCallSignatureDeclaration, params) == 64usize);
    assert!(offset_of!(TSCallSignatureDeclaration, return_type) == 72usize);
    ...
    assert!(offset_of!(TSMethodSignature, span) == 8usize);
    ...
    assert!(offset_of!(TSMethodSignature, type_parameters) == 40usize);
    assert!(offset_of!(TSMethodSignature, this_param) == 48usize);
    assert!(offset_of!(TSMethodSignature, params) == 56usize);
    assert!(offset_of!(TSMethodSignature, return_type) == 64usize);
    ...
    assert!(offset_of!(TSConstructSignatureDeclaration, span) == 8usize);
    assert!(offset_of!(TSConstructSignatureDeclaration, type_parameters) == 16usize);
    assert!(offset_of!(TSConstructSignatureDeclaration, params) == 24usize);
    ...
    assert!(offset_of!(TSIndexSignatureName, span) == 8usize);
    ...
    assert!(offset_of!(TSTypePredicate, span) == 8usize);
    ...
    assert!(size_of::<TSModuleDeclaration>() == 96usize);
    assert!(align_of::<TSModuleDeclaration>() == 8usize);
    assert!(offset_of!(TSModuleDeclaration, node_id) == 0usize);
    assert!(offset_of!(TSModuleDeclaration, span) == 8usize);
    assert!(offset_of!(TSModuleDeclaration, id) == 16usize);
    assert!(offset_of!(TSModuleDeclaration, body) == 72usize);
    assert!(offset_of!(TSModuleDeclaration, kind) == 88usize);
    assert!(offset_of!(TSModuleDeclaration, declare) == 89usize);
    assert!(offset_of!(TSModuleDeclaration, scope_id) == 92usize);

    assert!(size_of::<TSModuleDeclarationKind>() == 1usize);
    assert!(align_of::<TSModuleDeclarationKind>() == 1usize);

    assert!(size_of::<TSModuleDeclarationName>() == 56usize);
    ...
    assert!(offset_of!(TSModuleBlock, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeLiteral, span) == 8usize);
    ...
    assert!(offset_of!(TSInferType, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeQuery, span) == 8usize);
    ...
    assert!(offset_of!(TSImportType, span) == 8usize);
    assert!(offset_of!(TSImportType, is_type_of) == 16usize);
    assert!(offset_of!(TSImportType, parameter) == 24usize);
    assert!(offset_of!(TSImportType, qualifier) == 40usize);
    assert!(offset_of!(TSImportType, attributes) == 56usize);
    assert!(offset_of!(TSImportType, type_parameters) == 64usize);
    ...
    assert!(offset_of!(TSTemplateLiteralType, span) == 8usize);
    ...
    assert!(offset_of!(TSAsExpression, span) == 8usize);
    ...
    assert!(offset_of!(TSSatisfiesExpression, span) == 8usize);
    ...
    assert!(offset_of!(TSTypeAssertion, span) == 8usize);
    ...
    assert!(offset_of!(TSImportEqualsDeclaration, span) == 8usize);
    ...
    assert!(offset_of!(TSExternalModuleReference, span) == 8usize);
    ...
    assert!(offset_of!(TSNonNullExpression, span) == 8usize);
    ...
    assert!(offset_of!(Decorator, span) == 8usize);
    ...
    assert!(offset_of!(TSExportAssignment, span) == 8usize);
    ...
    assert!(offset_of!(TSNamespaceExportDeclaration, span) == 8usize);
    ...
    assert!(offset_of!(TSInstantiationExpression, span) == 8usize);
    ...
    assert!(offset_of!(JSDocNullableType, span) == 8usize);
    ...
    assert!(size_of::<JSXOpeningElement>() == 80usize);
    assert!(align_of::<JSXOpeningElement>() == 8usize);
    assert!(offset_of!(JSXOpeningElement, node_id) == 0usize);
    assert!(offset_of!(JSXOpeningElement, span) == 8usize);
    assert!(offset_of!(JSXOpeningElement, self_closing) == 16usize);
    assert!(offset_of!(JSXOpeningElement, name) == 24usize);
    assert!(offset_of!(JSXOpeningElement, attributes) == 40usize);
    assert!(offset_of!(JSXOpeningElement, type_parameters) == 72usize);
    ...
    assert!(offset_of!(JSXClosingElement, span) == 8usize);
    assert!(offset_of!(JSXClosingElement, name) == 16usize);

    assert!(size_of::<JSXFragment>() == 80usize);
    assert!(align_of::<JSXFragment>() == 8usize);
    assert!(offset_of!(JSXFragment, node_id) == 0usize);
    assert!(offset_of!(JSXFragment, span) == 8usize);
    assert!(offset_of!(JSXFragment, opening_fragment) == 16usize);
    assert!(offset_of!(JSXFragment, closing_fragment) == 32usize);
    assert!(offset_of!(JSXFragment, children) == 48usize);

    assert!(size_of::<JSXOpeningFragment>() == 16usize);
    assert!(align_of::<JSXOpeningFragment>() == 8usize);
    assert!(offset_of!(JSXOpeningFragment, node_id) == 0usize);
    assert!(offset_of!(JSXOpeningFragment, span) == 8usize);

    assert!(size_of::<JSXClosingFragment>() == 16usize);
    assert!(align_of::<JSXClosingFragment>() == 8usize);
    assert!(offset_of!(JSXClosingFragment, node_id) == 0usize);
    assert!(offset_of!(JSXClosingFragment, span) == 8usize);
    ...
    assert!(offset_of!(JSXNamespacedName, span) == 8usize);
    ...
    assert!(offset_of!(JSXMemberExpression, span) == 8usize);
    ...
    assert!(offset_of!(JSXExpressionContainer, span) == 8usize);
    ...
    assert!(offset_of!(JSXAttribute, span) == 8usize);
    ...
    assert!(offset_of!(JSXSpreadAttribute, span) == 8usize);
    ...
    assert!(offset_of!(JSXIdentifier, span) == 8usize);
    ...
    assert!(offset_of!(JSXSpreadChild, span) == 8usize);
    ...
    assert!(offset_of!(JSXText, span) == 8usize);
...
const _: () = {
    ...
    assert!(size_of::<StringLiteral>() == 28usize);
    ...
    assert!(offset_of!(StringLiteral, raw) == 20usize);
    ...
    assert!(size_of::<RegExpLiteral>() == 36usize);
    ...
    assert!(offset_of!(RegExpLiteral, raw) == 28usize);
    ...
    assert!(size_of::<SourceFile>() == 96usize);
    assert!(align_of::<SourceFile>() == 4usize);
    assert!(offset_of!(SourceFile, node_id) == 0usize);
    assert!(offset_of!(SourceFile, span) == 4usize);
    assert!(offset_of!(SourceFile, source_type) == 12usize);
    assert!(offset_of!(SourceFile, source_text) == 16usize);
    assert!(offset_of!(SourceFile, comments) == 24usize);
    assert!(offset_of!(SourceFile, hashbang) == 40usize);
    assert!(offset_of!(SourceFile, directives) == 60usize);
    assert!(offset_of!(SourceFile, body) == 76usize);
    assert!(offset_of!(SourceFile, scope_id) == 92usize);
    ...
    assert!(offset_of!(ObjectProperty, method) == 32usize);
    assert!(offset_of!(ObjectProperty, shorthand) == 33usize);
    assert!(offset_of!(ObjectProperty, computed) == 34usize);
    ...
    assert!(size_of::<TemplateExpression>() == 44usize);
    assert!(align_of::<TemplateExpression>() == 4usize);
    assert!(offset_of!(TemplateExpression, node_id) == 0usize);
    assert!(offset_of!(TemplateExpression, span) == 4usize);
    assert!(offset_of!(TemplateExpression, quasis) == 12usize);
    assert!(offset_of!(TemplateExpression, expressions) == 28usize);

    assert!(size_of::<NoSubstitutionTemplateLiteral>() == 20usize);
    assert!(align_of::<NoSubstitutionTemplateLiteral>() == 4usize);
    assert!(offset_of!(NoSubstitutionTemplateLiteral, node_id) == 0usize);
    assert!(offset_of!(NoSubstitutionTemplateLiteral, span) == 4usize);
    assert!(offset_of!(NoSubstitutionTemplateLiteral, value) == 12usize);

    assert!(size_of::<TemplateLiteralKind>() == 8usize);
    assert!(align_of::<TemplateLiteralKind>() == 4usize);

    assert!(size_of::<TaggedTemplateExpression>() == 32usize);
    ...
    assert!(offset_of!(TaggedTemplateExpression, type_parameters) == 28usize);
    ...
    assert!(size_of::<AssignmentTargetPropertyProperty>() == 32usize);
    ...
    assert!(offset_of!(AssignmentTargetPropertyProperty, computed) == 28usize);
    ...
    assert!(offset_of!(Directive, directive) == 40usize);
    ...
    assert!(offset_of!(Function, r#type) == 12usize);
    ...
    assert!(offset_of!(Class, r#type) == 12usize);
    ...
    assert!(offset_of!(MethodDefinition, r#type) == 12usize);
    ...
    assert!(offset_of!(PropertyDefinition, r#type) == 12usize);
    ...
    assert!(offset_of!(AccessorProperty, r#type) == 12usize);
    ...
    assert!(offset_of!(ImportExpression, phase) == 36usize);

    assert!(size_of::<ImportDeclaration>() == 68usize);
    ...
    assert!(offset_of!(ImportDeclaration, phase) == 56usize);
    assert!(offset_of!(ImportDeclaration, with_clause) == 60usize);
    ...
    assert!(size_of::<ImportSpecifier>() == 72usize);
    ...
    assert!(offset_of!(ImportSpecifier, local) == 44usize);
    assert!(offset_of!(ImportSpecifier, import_kind) == 68usize);
    ...
    assert!(offset_of!(ImportAttribute, value) == 44usize);

    assert!(size_of::<ImportAttributeKey>() == 32usize);
    assert!(align_of::<ImportAttributeKey>() == 4usize);

    assert!(size_of::<ExportNamedDeclaration>() == 72usize);
    ...
    assert!(offset_of!(ExportNamedDeclaration, export_kind) == 64usize);
    assert!(offset_of!(ExportNamedDeclaration, with_clause) == 68usize);

    assert!(size_of::<ExportDefaultDeclaration>() == 52usize);
    ...
    assert!(size_of::<ExportAllDeclaration>() == 80usize);
    ...
    assert!(offset_of!(ExportAllDeclaration, source) == 44usize);
    assert!(offset_of!(ExportAllDeclaration, with_clause) == 72usize);
    assert!(offset_of!(ExportAllDeclaration, export_kind) == 76usize);

    assert!(size_of::<ExportSpecifier>() == 80usize);
    ...
    assert!(offset_of!(ExportSpecifier, exported) == 44usize);
    assert!(offset_of!(ExportSpecifier, export_kind) == 76usize);

    assert!(size_of::<ExportDefaultDeclarationKind>() == 8usize);
    assert!(align_of::<ExportDefaultDeclarationKind>() == 4usize);

    assert!(size_of::<ModuleExportName>() == 32usize);
    ...
    assert!(offset_of!(TSIndexSignature, r#static) == 33usize);

    assert!(size_of::<TSCallSignatureDeclaration>() == 52usize);
    assert!(align_of::<TSCallSignatureDeclaration>() == 4usize);
    assert!(offset_of!(TSCallSignatureDeclaration, node_id) == 0usize);
    assert!(offset_of!(TSCallSignatureDeclaration, span) == 4usize);
    assert!(offset_of!(TSCallSignatureDeclaration, type_parameters) == 12usize);
    assert!(offset_of!(TSCallSignatureDeclaration, this_param) == 16usize);
    assert!(offset_of!(TSCallSignatureDeclaration, params) == 44usize);
    ...
    assert!(offset_of!(TSMethodSignature, type_parameters) == 24usize);
    assert!(offset_of!(TSMethodSignature, this_param) == 28usize);
    assert!(offset_of!(TSMethodSignature, params) == 32usize);
    assert!(offset_of!(TSMethodSignature, return_type) == 36usize);
    ...
    assert!(offset_of!(TSConstructSignatureDeclaration, type_parameters) == 12usize);
    assert!(offset_of!(TSConstructSignatureDeclaration, params) == 16usize);
    assert!(offset_of!(TSConstructSignatureDeclaration, return_type) == 20usize);
    ...
    assert!(size_of::<TSModuleDeclaration>() == 60usize);
    ...
    assert!(offset_of!(TSModuleDeclaration, body) == 44usize);
    assert!(offset_of!(TSModuleDeclaration, kind) == 52usize);
    assert!(offset_of!(TSModuleDeclaration, declare) == 53usize);
    ...
    assert!(size_of::<TSImportAttribute>() == 52usize);
    ...
    assert!(offset_of!(TSImportAttribute, value) == 44usize);
    ...
    assert!(offset_of!(TSFunctionType, type_parameters) == 12usize);
    assert!(offset_of!(TSFunctionType, this_param) == 16usize);
    assert!(offset_of!(TSFunctionType, params) == 20usize);
    ...
    assert!(offset_of!(TSConstructorType, params) == 20usize);
    ...
    assert!(size_of::<TSExternalModuleReference>() == 40usize);
    ...
    assert!(size_of::<JSXFragment>() == 52usize);
    ...
    assert!(offset_of!(JSXFragment, closing_fragment) == 24usize);
    assert!(offset_of!(JSXFragment, children) == 36usize);

    assert!(size_of::<JSXOpeningFragment>() == 12usize);
    assert!(align_of::<JSXOpeningFragment>() == 4usize);
    assert!(offset_of!(JSXOpeningFragment, node_id) == 0usize);
    assert!(offset_of!(JSXOpeningFragment, span) == 4usize);

    assert!(size_of::<JSXClosingFragment>() == 12usize);
    assert!(align_of::<JSXClosingFragment>() == 4usize);
    assert!(offset_of!(JSXClosingFragment, node_id) == 0usize);
    assert!(offset_of!(JSXClosingFragment, span) == 4usize);
