...
impl<'new_alloc> CloneIn<'new_alloc> for ElementAccessExpression<'_> {
    type Cloned = ElementAccessExpression<'new_alloc>;
    fn clone_in(&self, allocator: &'new_alloc Allocator) -> Self::Cloned {
...
impl<'new_alloc> CloneIn<'new_alloc> for AssignmentTargetMaybeDefault<'_> {
    ...
    fn clone_in(&self, allocator: &'new_alloc Allocator) -> Self::Cloned {
        match self {
            ...
            Self::ElementAccessExpression(it) => {
                AssignmentTargetMaybeDefault::ElementAccessExpression(CloneIn::clone_in(
                    it, allocator,
                ))
            }
            Self::StaticMemberExpression(it) => {
...
impl<'new_alloc> CloneIn<'new_alloc> for Statement<'_> {
    ...
    fn clone_in(&self, allocator: &'new_alloc Allocator) -> Self::Cloned {
        match self {
            ...
            Self::VariableDeclarationList(it) => {
                Statement::VariableDeclarationList(CloneIn::clone_in(it, allocator))
            }
...
impl<'new_alloc> CloneIn<'new_alloc> for Declaration<'_> {
    ...
    fn clone_in(&self, allocator: &'new_alloc Allocator) -> Self::Cloned {
        match self {
            Self::VariableDeclarationList(it) => {
                Declaration::VariableDeclarationList(CloneIn::clone_in(it, allocator))
            }
            Self::FunctionDeclaration(it) => {
...
impl<'new_alloc> CloneIn<'new_alloc> for VariableDeclarationList<'_> {
    type Cloned = VariableDeclarationList<'new_alloc>;
    fn clone_in(&self, allocator: &'new_alloc Allocator) -> Self::Cloned {
...
impl<'new_alloc> CloneIn<'new_alloc> for ForStatementInit<'_> {
    ...
    fn clone_in(&self, allocator: &'new_alloc Allocator) -> Self::Cloned {
        match self {
            Self::VariableDeclarationList(it) => {
                ForStatementInit::VariableDeclarationList(CloneIn::clone_in(it, allocator))
            }
            Self::BooleanLiteral(it) => {
...
impl<'new_alloc> CloneIn<'new_alloc> for ForStatementLeft<'_> {
    ...
    fn clone_in(&self, allocator: &'new_alloc Allocator) -> Self::Cloned {
        match self {
            Self::VariableDeclarationList(it) => {
                ForStatementLeft::VariableDeclarationList(CloneIn::clone_in(it, allocator))
            }
            Self::AssignmentTargetIdentifier(it) => {
...
impl<'new_alloc> CloneIn<'new_alloc> for ExportDefaultDeclarationKind<'_> {
    ...
    fn clone_in(&self, allocator: &'new_alloc Allocator) -> Self::Cloned {
        match self {
            ...
            Self::ElementAccessExpression(it) => {
                ExportDefaultDeclarationKind::ElementAccessExpression(CloneIn::clone_in(
                    it, allocator,
                ))
            }
            Self::StaticMemberExpression(it) => {
